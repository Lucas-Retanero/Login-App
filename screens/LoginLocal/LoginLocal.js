...
export default function LoginLocal({ navigation }) {
  ...
  const handleLogin = async () => {
    try {
      const userData = localStorage.getItem('usuarioLocal');
      ...
      if (savedEmail === email.trim() && savedSenha === password) {
        setHasError(false);
        setShowModal(false);
      ...
      console.log('Erro no login local:', e);
      setHasError(true);
      setShowModal(true);
    }
  };
      ...
      >
        <View style={loginStyles.loginContainer}>
          ...
          <Text style={loginStyles.loginSubtitle}>
            Faça login para continuar (LocalStorage)
          </Text>
          ...
          <View style={loginStyles.forgotWrapper}>
            <Pressable
              onPress={() => navigation.navigate('EsqueciSenhaLocal')}
              hitSlop={8}
            >
          ...
          <View style={loginStyles.registerTextWrapper}>
            ...
            <Pressable
              onPress={() => navigation.navigate('CriarContaLocal')}
            >
